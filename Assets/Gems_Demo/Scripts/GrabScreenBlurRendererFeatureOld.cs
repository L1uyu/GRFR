...
public class GrabScreenBlurRendererFeatureOld : ScriptableRendererFeature
{
    [Serializable]
    public class Config
    {
    ...
    {
        grabScreenBlurPass.SetUpColorRT(renderer.cameraColorTargetHandle);
    }
    ...
    class GrabScreenBlurPass : ScriptableRenderPass
    {
        ...
        {
            blurMat = CoreUtils.CreateEngineMaterial(Shader.Find("Custom/MyBlur"));
